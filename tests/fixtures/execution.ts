...
export class ExecutionWorker {
  ...
  async echo(
    @JobData() payload: PayloadOf<ExecutionQueue['echo']>,
    @JobContext() context: JobExecutionContext
  ): Promise<ResultOf<ExecutionQueue['echo']>> {
  ...
  async codec(
    @JobData() payload: PayloadOf<ExecutionQueue['codec']>
  ): Promise<ResultOf<ExecutionQueue['codec']>> {
  ...
  async retrying(
    @JobData() payload: PayloadOf<ExecutionQueue['retrying']>,
    @JobContext() context: JobExecutionContext
  ) {
    this.log.contexts.push(context)
  ...
  unique(@JobData() payload: PayloadOf<ExecutionQueue['unique']>) {
    return payload.key
  }
  ...
  invalidResult(@JobData() payload: string) {
