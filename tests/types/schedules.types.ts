import { z } from 'zod'
import { Job, QueueService, type MqSchedulesService, type ScheduleOptions } from '../../src/index.ts'
...
export const interval: ScheduleOptions<{ count: number }> = { key: 'valid', everyMs: 1_000, payload: { count: 1 } }
// @ts-expect-error A schedule has exactly one cadence, never both.
export const mixed: ScheduleOptions = { key: 'bad', cron: '* * * * *', everyMs: 1_000, payload: null }
