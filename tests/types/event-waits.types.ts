...
export const eventWait: JobWaitOptions = { strategy: 'events', pollFallbackMs: 1000, timeoutMs: 5000 }
export const pollWait: JobWaitOptions = { pollIntervalMs: 100, signal: new AbortController().signal }
