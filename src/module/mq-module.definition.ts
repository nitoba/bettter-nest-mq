...
export const { ConfigurableModuleClass } = new ConfigurableModuleBuilder<MqModuleOptions>({ moduleName: 'Mq', optionsInjectionToken: MODULE_OPTIONS_TOKEN })
  ...
  .setExtras({ isGlobal: false }, (definition, extras) => ({
    ...
    providers: [
      ...
      MqConnectionsService, MqWorkersService, MqQueueControlsService
    ],
    exports: [...(definition.exports ?? []), MqConfiguration, MqRegistry, MqConnectionsService, MqWorkersService, MqQueueControlsService]
  })).build()
