...
replace(
  'README.md',
  'See [distributed controls](docs/controls.md)',
  'See [PostgreSQL JSON fidelity](docs/postgres-json.md), [distributed controls](docs/controls.md)'
)
replace(
  'README.md',
...
replace(
  'AGENTS.md',
  'Read docs/controls.md, README.md',
  'Read docs/postgres-json.md, docs/controls.md, README.md'
)
replace(
  'AGENTS.md',
